import type {APIClient} from 'eosjs-core-gk'
import type {ChainIdType} from 'signing-request-gk'
...
export interface LinkChainConfig {
    ...
    chainId: ChainIdType
    /**
     * URL to EOSIO node to communicate with (or a eosjs-core-gk APIClient instance).
     */
